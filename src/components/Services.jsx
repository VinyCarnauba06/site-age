...
export default function Services() {
  const services = [
    {
      ...
      description: 'Controle de fluxo de caixa, prestação de contas hiper-detalhada e previsão orçamentária para obras e manutenções.'
    },
    {
      ...
      description: 'Régua de cobrança automatizada e negociação extrajudicial humanizada para erradicar a inadimplência no condomínio.'
    },
    {
      ...
      description: 'Gestão de manutenções, contratos de terceirizados (elevadores, bombas) e adequação rigorosa às normas de segurança.'
    },
    {
      icon: 'M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z',
      title: 'Organização de Assembleias',
      description: 'Elaboração de editais, condução técnica de reuniões, redação de atas e suporte jurídico para deliberações complexas.'
    },
  ]
  ...
  return (
    <section id="setores" className="services section-padding">
